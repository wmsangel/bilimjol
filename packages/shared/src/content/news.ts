...
export const news: NewsItem[] = [
  {
    ...
    emoji: "✏️",
    title: {
      ru: "Новая игра «Обводилки» — готовим руку к письму",
      ky: "Жаңы оюн «Сызуучулар» — колду жазууга даярдайбыз",
    },
    href: "/games/trace",
  },
  {
    ...
    emoji: "🎒",
    title: {
      ru: "Новый тест: готов ли ребёнок к школе? Пройдите за 2 минуты",
      ky: "Жаңы тест: бала мектепке даярбы? 2 мүнөттө өтүңүз",
    },
